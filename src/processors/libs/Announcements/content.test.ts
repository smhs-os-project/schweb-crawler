...
const buildAU = (path: string) => `http://www.smhs.kh.edu.tw${path}`;
...
describe("relativeUrlParser()", () => {
  ...
  it(`https://www.google.com/awaw -> https://www.google.com/awaw`, () => {
    expect(relativeUrlParser("https://www.google.com/awaw")).toBe(
      "https://www.google.com/awaw"
    );
  });

  it(`http://www.google.com/awaw -> http://www.google.com/awaw`, () => {
    expect(relativeUrlParser("http://www.google.com/awaw")).toBe(
      "http://www.google.com/awaw"
    );
  });
